/// Advanced example demonstrating all Recording Shield features.
///
/// To run this example:
/// ```bash
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          SizedBox(height: 24),
          SensitiveStripesSection(),
          SizedBox(height: 24),
          SensitiveBlurSection(),
          SizedBox(height: 24),
          SensitiveSolidSection(),
          SizedBox(height: 24),
          CheckStateButton(),
        ],
      ),
...
class PublicContentSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text('Public Content', style: Theme.of(context).textTheme.titleLarge),
        const SizedBox(height: 8),
        const Card(
          child: Padding(
            padding: EdgeInsets.all(16),
            child: Text('This content is always visible, even during recording.'),
          ),
        ),
      ],
    );
